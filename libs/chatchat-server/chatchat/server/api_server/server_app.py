...
from chatchat.server.api_server.audio_routes import audio_router
from chatchat.server.chat.kb_chat import stream_chat
from chatchat.server.chat.kb_graph_chat import kb_graph_chat
...
def create_app(run_mode: str = None):
    ...
    app.websocket("/local_doc_qa/stream_chat/{knowledge_base_id}")(kb_graph_chat)
    app.websocket("/local_kg_qa/stream_chat/{knowledge_base_id}")(kb_graph_chat)
    return app
