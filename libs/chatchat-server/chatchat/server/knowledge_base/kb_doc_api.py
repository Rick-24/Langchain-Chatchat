...
def upload_text(knowledge_base_name: str = Body(..., examples=["samples"]),
    ...
    return upload_docs([file], knowledge_base_name, True,True, 512, 256, True, {}, False)
...
def delete_doc(
    ...
    return delete_docs(knowledge_base_name, [file_name])
